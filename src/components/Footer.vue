<template>
  <footer class="footer bg-dark text-center text-white position-relative bottom-0 w-100 pb-3">
        ...
        <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center mt-1">
          <div class="me-3">
            <a href="https://www.facebook.com/mgzofficial/" target="_blank" class="meta">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#BFBFBF" class="bi bi-meta"
                  viewBox="0 0 16 16">
                  <path fill-rule="evenodd"
                    d="M8.217 5.243C9.145 3.988 10.171 3 11.483 3 13.96 3 16 6.153
                    16.001 9.907c0 2.29-.986 3.725-2.757 3.725-1.543
                    0-2.395-.866-3.924-3.424l-.667-1.123-.118-.197a54.944 54.944 0 0
                    0-.53-.877l-1.178 2.08c-1.673 2.925-2.615 3.541-3.923
                    3.541C1.086 13.632 0 12.217 0 9.973
                    0 6.388 1.995 3 4.598 3c.319 0
                    .625.039.924.122.31.086.611.22.913.407.577.359 1.154.915
                    1.782 1.714Zm1.516 2.224c-.252-.41-.494-.787-.727-1.133L9
                    6.326c.845-1.305 1.543-1.954
                    2.372-1.954 1.723 0 3.102 2.537 3.102 5.653 0 1.188-.39
                    1.877-1.195 1.877-.773
                      0-1.142-.51-2.61-2.87l-.937-1.565ZM4.846 4.756c.725.1
                      1.385.634 2.34 2.001A212.13 212.13
                      0 0 0 5.551 9.3c-1.357 2.126-1.826 2.603-2.581
                      2.603-.777 0-1.24-.682-1.24-1.9 0-2.602
                      1.298-5.264 2.846-5.264.091 0 .181.006.27.018Z" />
                </svg>
            ...
            <a href="https://www.instagram.com/mgzofficial/" target="_blank" class="ins">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-instagram"
                ...
                <path
                  ...
                  2.76.42a3.917 3.917 0 0 0-1.417.923A3.927
                  3.927 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01
                  5.555 0 5.827 0 8.001c0 2.172.01 2.444.048
                  3.297.04.852.174 1.433.372 1.942.205.526.478.972.923
                  1.417.444.445.89.719 1.416.923.51.198
                  1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01
                  ...
                  10.172 0 7.998 0h.003zm-.717 1.442h.718c2.136
                  0 2.389.007 3.232.046.78.035
                  ...
                  0-1.92zm-4.27 1.122a4.109 4.109 0 1 0 0 8.217
                  4.109 4.109 0 0 0 0-8.217zm0 1.441a2.667 2.667
                  0 1 1 0 5.334 2.667 2.667 0 0 1 0-5.334z" />
              </svg>
    ...
    <div class="copyright opacity-50 tracking-wider">
