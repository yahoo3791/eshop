<template>
  ...
  <div class="bg-dark">
    <div class="container">
      <div class="row">
        <div class="col-10 col-md-6 mx-auto text-white text-center" style="padding-top:20vh; padding-bottom:10vh">
          <h1 class="text-xl">查詢訂單</h1>
          <div class="d-flex py-3">
            <input id="message" name="留言" class="carts-input p-2 border-0 border-bottom text-white tracking-wider"
    ...
    <div class="container text-white" style="padding-bottom:20vh;padding-top:10vh" :class="{'d-none': !getOrder}">
      <div class="row">
        <div class="col-10 col-md-6 mx-auto">
          ...
          <div class="row">
            ...
            <div class="col-12 text-white mb-5">
              <div class="payCart-item border-bottom d-flex py-3" v-for="item in order.products">
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div v-for="item,k in order.products" :key="item.k">
                <p v-if="!item.coupon == 0">{{ item.product.title }} 已使用優惠卷，折扣{{ Math.round($filters.currency(item.total
                - item.final_total)) }}$</p>
              </div>
