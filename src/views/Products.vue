<template>
  ...
  <div class="bg-dark">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-3 mb-5">
          <div class="list-group px-md-0 text-center" @click.prevent="productsFilter($event)">
            ...
            list-group-item-action bg-dark text-white border border-top-0">時尚</a>
            <a href="#" :class="{' products-active ' : this.clickText === '藝術'}" class="list-group-item 
            list-group-item-action bg-dark text-white border border-top-0">藝術</a>
            <a href="#" :class="{' products-active ' : this.clickText === '旅遊'}" class="list-group-item 
            list-group-item-action bg-dark text-white border border-top-0">旅遊</a>
            <a href="#" :class="{' products-active ' : this.clickText === '汽車'}" class="list-group-item 
            list-group-item-action bg-dark text-white border border-top-0">汽車</a>
          </div>
        </div>
        <div class="col-12 col-md-9 d-flex flex-column flex-md-row flex-md-wrap">
          <div class="product-outside pb-5 px-md-3 text-white" v-for="item,index in products" :key="item.id" >
    ...
    <div @click="this.openDrawer = true" class="drawer-container position-fixed bottom-0 end-0 text-center">
        <w-badge class="position-absolute" style="top:15px;right:15px" v-model="this.cartsNum" bg-color="error" overlap></w-badge>
    ...
    <div :class="{ 'd-none' : scrollIcon }" class="scrollTop-container position-fixed end-0 text-center">
      <a @click.prevent="scrollToTop" href="/#/user/products" class="scrollTop-btn d-block p-2 m-1 rounded-circle text-white">
        ...
        <div class="container">
          <div v-if="this.carts.length == 0" class="row" style="padding-top:150px">
            ...
            <div v-else-if="this.carts.length !== 0" class="row" style="padding-top:150px">
              ...
              <div class="col-12">
                <router-link to="/user/carts" class="d-block text-center">
                  <w-button class="text-black px-3 py-md-3 px-md-4 py-lg-4 px-lg-5 w-100" lg bg-color="white" tile>結帳</w-button>
                </router-link>
              </div>
            </div>
        </div>
