      ...
      <div class="row text-white flex-column-reverse flex-md-row">
          ...
          <Form @submit="submit">
            <div class="py-3 position-relative">
              <h3 class="d-block formData-label
                tracking-wide text-sm" for="name">*聯絡人姓名</h3>
            ...
            <div class="py-3 position-relative">
              <h3 class="tracking-wide text-sm">性別</h3>
            ...
            <div class="py-3 position-relative">
              <h3 class="d-block formData-label  tracking-widest text-sm"
                for="phone">*聯絡人手機</h3>
            ...
            <div class="py-3 position-relative">
              <h3 class="d-block formData-label
                tracking-widest text-sm" for="address">*收件人地址</h3>
            ...
            <div class="py-3 position-relative">
              <label ref="formMessage" class="ps-2 d-block formData-label
                ...
                class="text-sm tracking-wide opacity-75"></span>
            ...
            <div class="py-3 position-relative">
              <label for="payment" class="d-block text-sm">*付款方式
        ...
        <div class="col-12 col-md-5 offset-md-1">
          ...
          <div class="text-white text-end tracking-widest font-semibold text-base">
            <div :class="{'d-none': coupon}">總價{{cartsData.total}}
              <i class="bi bi-currency-dollar"></i>
            </div>
            <div class=""><del :class="{'d-none' : !coupon}"
              style="text-decoration-color: red;">總價{{cartsData.total}}$</del></div>
            <div
              class="col-12 pt-2 pb-3 text-white text-end tracking-widest font-semibold text-base">
